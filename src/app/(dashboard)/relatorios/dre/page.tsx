  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto space-y-4">
      <div className="flex items-center justify-between print:hidden">
        <div>
          <h1 className="text-lg font-bold text-gray-900">Relatório: DRE (Resultado do Exercício)</h1>
          <p className="text-xs text-gray-500">Demonstração de receitas, custos, despesas e apuração do lucro líquido.</p>
        </div>
        <button
